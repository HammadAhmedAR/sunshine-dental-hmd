...
public class AppointmentDetailsServlet extends HttpServlet {
    @Override protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            req.setAttribute("appointment", Services.get(getServletContext()).appointmentQueries().find(req.getParameter("number")));
            ViewSupport.page(req, res, "appointments/details", "Appointment details", "appointments");
